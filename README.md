<img src="https://github.com/MightyKnight/BadlionClientDisabler/blob/master/src/main/resources/assets/blcdisabler/icon.png" width="128" height="128" />

# BadlionClientDisabler
![Java 8](https://img.shields.io/badge/language-Java%208-9B599A.svg?style=flat-square)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](https://opensource.org/licenses/MIT)
![](https://img.shields.io/badge/environment-server-blue)
...
![Version](https://img.shields.io/github/v/tag/MightyKnight/BadlionClientDisabler?label=version)
<p align="center">
...
:warning: A full list of modules and submodules that can be disabled is provided [here](https://github.com/MightyKnight/BadlionClientDisabler/wiki/Modules-to-disable).
...
:green_book: [**List of all features that can be used in the config.**](https://github.com/MightyKnight/BadlionClientDisabler/wiki/Modules-to-disable)  
